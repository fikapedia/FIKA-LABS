...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      P("The GARP Risk Institute ran the benchmark that makes the point. Jo Paisley and Maxine Nelson assessed 13 physical risk vendors anonymously for the Financial Resilience Working Group of the UK's Climate Financial Risk Forum, published October 2025 as A Risk Professional's Guide to Physical Risk Assessments. Every vendor received the same 100 properties across the UK, mainland Europe, the US and Asia."),
      table([3400, 5960],
        ["Measure", "What the study found"],
        [
          ["Flood damage-ratio correlation between vendors", "Ranged from 0.2 to 0.9"],
          ["Warming under the same RCP 8.5 scenario", "0.7\u00B0C spread by 2025, widening to 3.2\u20135.7\u00B0C by 2100"],
          ["Hazard exposure", "The same property rated highly exposed by some vendors and not exposed at all by others"],
          ["Damage ratios", "Dispersion across every peril tested: coastal flood, cyclone, windstorm and heat"],
          ["Hazard to damage relationship", "Sensible across vendor means, but extremely variable vendor by vendor"],
        ]),
      new Paragraph({ spacing: { after: 140 } }),
      P("The warming figure is the one worth showing a client. These vendors were handed an identical scenario and still landed roughly 2.5\u00B0C apart by 2100, so the divergence does not start at the property. It starts at the climate input and compounds downward. GARP calls this the complexity cascade: modelling choices stack across weather, hydrology, hydraulics, damage functions and scenarios."),
      ...
      CALLOUT("GARP's own conclusion is blunt: there is no best vendor. Suitability depends on the use case and the data quality behind it. Treat any single-vendor number as an opinion, not a measurement."),
